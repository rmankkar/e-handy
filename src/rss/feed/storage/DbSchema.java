...
public final class DbSchema {
	...
	public static final class FeedSchema implements BaseColumns {
		...
		public static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME
				...
				+ COLUMN_URL + " TEXT NOT NULL," + COLUMN_HOMEPAGE
	...
	public static final class ItemSchema implements BaseColumns {
		...
		public static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME
				...
				+ " TEXT," + COLUMN_CONTENT + " TEXT," + COLUMN_IMAGE
				+ " TEXT," + COLUMN_PUBDATE + " INTEGER NOT NULL,"
				+ COLUMN_FAVORITE + " INTEGER NOT NULL," + COLUMN_READ
				+ " INTEGER NOT NULL);";
		public static final String DROP_TABLE = "DROP TABLE IF EXISTS "
				+ TABLE_NAME;
	}
